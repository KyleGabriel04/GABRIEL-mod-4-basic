...
def savings(gross_pay, tax_rate, expenses):
    ...
    print("Savings Amount: " + str(savings) + "Centavos")
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    material_units = str(input("Unit of Measure: "))
    ...
    print("Amount of remaining material: " + str(material_waste) + material_units)
...
def interest(principal, rate, periods):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    principal = int(input("Principal Amount Invested: "))
    ...
    print("Investment Amount: " + str(interest))
...
def body_mass_index(weight, height):
    ...
    height = str(height_ft) + "'" + str(height_in)
    weight /= 2.2
    ...
    print("Weight (kg): " + str(weight) + "Height (ft): " + str(height) + "Body Mass Index: " + str(bmi) + "BMI Category: " + bmi_category)
